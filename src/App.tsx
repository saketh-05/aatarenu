        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ delay: 1 }}
            >
              Relive your childhood memories with our digital version of the beloved Hand Cricket game. 
              Challenge players worldwide and become the ultimate champion!
            </motion.p>
            <motion.button 
              ...
              <div className="md:w-1/2">
                ...
                <ul className="space-y-4 text-blue-100 text-xl">
                  <motion.li 
                    ...
                    whileHover={{ x: 10 }}
                  >
                    <span className="text-blue-300">1.</span> Choose a number between 1 and 6
                  </motion.li>
                  <motion.li 
                    className="flex items-start gap-2"
                    initial={{ opacity: 0, x: -20 }}
                    ...
                    whileHover={{ x: 10 }}
                  >
                    <span className="text-blue-300">2.</span> If your number matches with the computer, you're out!
                  </motion.li>
                  <motion.li 
                    className="flex items-start gap-2"
                    initial={{ opacity: 0, x: -20 }}
                    ...
                    whileHover={{ x: 10 }}
                  >
                    <span className="text-blue-300">3.</span> Take turns batting and bowling
                  </motion.li>
                  <motion.li 
                    className="flex items-start gap-2"
                    initial={{ opacity: 0, x: -20 }}
                    ...
                    whileHover={{ x: 10 }}
                  >
                    <span className="text-blue-300">4.</span> Score the most runs to win!
                  </motion.li>
                </ul>
                <motion.button 
                  whileHover={{ scale: 1.05 }}
